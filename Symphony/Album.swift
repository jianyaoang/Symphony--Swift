...
//?? operation 
//ex. let abc = possiblyNilVariable ?? "Definitely Not Nil Variable"
//abc is set to possiblyNilVariable if it's not nil
//if it's nil, abc uses the value on the right-handside of ??. In this example, if it's nil, abc = "Definitely Not Nil Variable" string
//this helps to prevent getting nil values passed to our Album
}